...
<div className="flex items-center justify-between mt-8 ml-14 mr-14">
  ...
  <button
            className="relative w-full lg:w-28 h-8 py-1 px-4 border border-grey text-black bg-white"
          ...
          >
            ...
            <span className="relative z-20 font-montserrat font-normal">Add course</span>
          </button>
</div>
    ...
    <option>option3</option>
          ...
          <table className="border-2 w-[900px]">
            <thead className="">
              <tr className="grid grid-cols-12 gap-4 justify-items-start py-2 bg-neutral-50 text-gray-700 ">
                ...
                <th className="col-span-3 font-semibold font-montserrat">Category</th>
        ...
        <td className="col-span-3" >
                                    <span
                                        ...
                                        <span aria-hidden
                                            class="absolute inset-0 bg-greey opacity-50 rounded-full"></span>
                                        <span class="relative">Technology</span>
                                    </span>
                                </td>

...
const TopCathegories = () => {
  ...
  return (
    <section className="lg:h-[500px] max-lg:h-[800px] bg-greey lg:pl-20 max-lg:p-4 lg:flex  lg:gap-10 xl:gap-32 py-12">
      <div >
      ...
      <div className="grid grid-cols-2 gap-6  h-[310px] lg:w-[600px] max-lg:max-w-[600px] max-lg:mx-auto   lg:mt-10  ">
